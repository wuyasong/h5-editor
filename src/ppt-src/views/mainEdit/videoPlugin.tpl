<div class="ui-draggable controls-video active" id="{{id}}" style="width:{{style.width}}px;height:{{style.height}}px;display:{{style.display}};left:{{style.left}}px;top:{{style.top}}px;z-index:{{style.zIndex}};" data-hdy-ev="contextmenu:onContextmenu">
    ...
    <div class="drag-ele" style="background-image: url({{poster ? poster : '/images/video_poster_icon.png'}});">
    </div>
</div>