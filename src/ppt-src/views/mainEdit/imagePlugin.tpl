<div class="ui-draggable controls-image active" id="{{id}}" style="width:{{style.width}}px;height:{{style.height}}px;display:{{style.display}};left:{{style.left}}px;top:{{style.top}}px;z-index:{{style.zIndex}};" data-hdy-ev="contextmenu:onContextmenu">
    ...
    <div class="drag-ele">
        <img src="{{src}}" class="drag-ele-img" style="border-radius:{{style.borderRadius}}px;opacity:{{style.opacity}};border:{{style.borderWidth}}px {{style.borderStyle}} {{style.borderColor}};">
    </div>
</div>